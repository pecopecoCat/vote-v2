...
export const SEED_COMMUNITY_IDS = {
  kondate: "col-seed-kondate",
  shigoto: "col-seed-shigoto",
  warmama: "col-seed-warmama",
...
export const OTHER_USERS_COLLECTIONS: Collection[] = [
  ...
  {
    id: SEED_COMMUNITY_IDS.dramaEnd,
    name: "ドラマの結末もやっと話",
    color: "#C4B5FD",
